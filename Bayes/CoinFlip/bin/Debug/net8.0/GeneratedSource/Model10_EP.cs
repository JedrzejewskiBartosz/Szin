...
namespace Models
{
	...
	{
		#region Fields
		/// <summary>True if Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9 has executed. Set this to false to force re-execution of Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9</summary>
		public bool Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9 has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9</summary>
		public bool Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9</summary>
		public bool Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isInitialised;
		...
		public double vdouble10
		{
			...
			set {
				if (this.vdouble10_field!=value) {
					...
					this.Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isInitialised = false;
					this.Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone = false;
				}
			}
		}
		...
		#region Methods
		/// <summary>Computations that depend on the observed value of numberOfIterations and vdouble10 and vdouble11 and vdouble6 and vdouble7 and vdouble8 and vdouble9</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9(int numberOfIterations)
		{
			if (this.Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone) {
				return ;
			}
			...
			this.Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone = true;
		}

		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and must reset on changes to vdouble10 and vdouble11 and vdouble6 and vdouble7 and vdouble8 and vdouble9</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9(bool initialise)
		{
			if (this.Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone&&((!initialise)||this.Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isInitialised)) {
				return ;
			}
			...
			this.Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone = true;
			this.Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isInitialised = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			if (numberOfIterations!=this.numberOfIterationsDone) {
				if (numberOfIterations<this.numberOfIterationsDone) {
					this.numberOfIterationsDone = 0;
					this.Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone = false;
				}
				this.Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9_isDone = false;
			}
			...
			this.Constant();
			this.Changed_numberOfIterationsDecreased_Init_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9(initialise);
			this.Changed_numberOfIterations_vdouble10_vdouble11_vdouble6_vdouble7_vdouble8_vdouble9(numberOfIterations);
